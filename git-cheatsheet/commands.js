...
var translations = {
  en: {
    ...
    commands: {
      ...
      "add x": {"cmd": "add <fichero... o directorio...>", "docs": "Añade el contenido atual de ficheros nuevos o modificados al índice, preparande de ese modo el contenido para su inclusión en la próxima acometida. Use `add --interactive` para añadir los contenidos modificados del espacio de trabajo interactivamente al índice."},
